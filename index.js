...
// List of options on the main list
main = async () => {
    try {
    ...
    try {   
        ...
        const inqRes = await inquirer.prompt([
            ...
            },
            {
                type: "list",
                name: "dept",
                message: "Which department is this role placed in? ",
                choices: deptArr
            }
        ]);
...
//Getting department ID when given the department name
var getDeptId = (dept) => {  
    return new Promise((resolve, reject) => {
...
//Getting an array of all of the current roles
var getRolesArr = () => {
    return new Promise((resolve, reject) => {
        var roles = [];
...
//Getting an array of all of the current employees
var getEmployeesArr = () => {
    return new Promise((resolve, reject) => {
        var employees = [];
